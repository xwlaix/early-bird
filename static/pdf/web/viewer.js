  ...
  return {
    ...
    documentProperties: {
      ...
      fields: {
        ...
        'size': document.getElementById('pageSizeField'),
...
PDFPrintService.prototype = {
  layout: function layout() {
    ...
    var size = this.pagesOverview[0];
    this.pageStyleSheet.textContent = '@supports ((size:A4) and (size:1pt 1pt)) {' + '@page { size: ' + size.width + 'pt ' + size.height + 'pt;}' + '}';
